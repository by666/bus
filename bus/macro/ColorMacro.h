...
#define c01 [STColorUtil colorWithHexString:@"#3A5FCD"]
#define c02 [STColorUtil colorWithHexString:@"#436EEE"]
#define c03 [STColorUtil colorWithHexString:@"#919191" alpha:0.5f]
#define c04 [STColorUtil colorWithHexString:@"#FFFAFA"]
...
#define cline  [STColorUtil colorWithHexString:@"#E5E5E5"]
